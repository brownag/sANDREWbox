...
mu_source <- 'S:/NRCS/Archive_Andrew_Brown/CA630/Ecosites' # polygon feature path 
mu_layer <- 'mesic_mehrten_LRU_newsyms' # polygon feature class for overlay NASIS pedons 

output_directory <- "gpps_mehrten_lrusplit"
poly_attribute <-  'newmusym' #attribute containing unique identifyer of feature classes (e.g 'MUSYM')
