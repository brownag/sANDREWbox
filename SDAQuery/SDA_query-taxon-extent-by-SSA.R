...
component_data <- subset(component_data, !is.na(component_data[[group_level]])) ## NOTE: taxsubgrp hardcoded
...
subgrps <- split(major_component_data, group_level) ## NOTE: taxsubgrp hardcoded
