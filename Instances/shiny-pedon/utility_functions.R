...
summarize.component <- function(f.i) {
  ...
  vars <- c('hzdept','hzdepb','clay', 'sand', 'phfield', 'gravel', 'paragravel', 'cobbles', 'paracobbles', 'stones', 'channers', 'total_frags_pct', 'albedo')
  # better names, used in final tables / figures
  var.names <- c('HZ', 'hzdept','hzdepb', 'clay', 'sand', 'pH', 'GR', 'PGR', 'CB', 'PCB', 'ST', 'CN', 'Total RF', 'Albedo')
