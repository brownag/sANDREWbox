...
output:
  html_document:
    ...
    keep_md: no
---
<!-- mu-comparison (v3.3.8) -- instance created 2019-10-21 13:17:43-->  
...
## project
if(is.na(is.projected(mu)) || !is.projected(mu)) {
  proj4string(mu) <- "+proj=longlat +datum=WGS84"
  mu <- spTransform(mu, CRS("+proj=utm +zone=10 +units=m +datum=WGS84"))
}
